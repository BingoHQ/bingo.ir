...
<form id="order_review" method="post">
    ...
    <div id="payment">
        ...
        <div class="form-row">
            ...
            <?php echo apply_filters('woocommerce_pay_order_button_html', '<input type="submit" class="bingo-btn alt" id="place_order" value="' . esc_attr($order_button_text) . '" data-value="' . esc_attr($order_button_text) . '" />'); ?>
