...
<div class="wrap" id="tnp-wrap">
    ...
    <div id="tnp-heading">
        ...
        <p>
            Please, <a href="https://www.thenewsletterplugin.com/plugins/newsletter/newsletter-locked-content"
                       target="_blank">read more here how to use and configure</a>,
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <p class="description">
                            ...
                            <br>
                            Newsletters with tracking active can link directly the pages with locked content since the
                            URLs will
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <p class="description">
                            ...
                            [newsletter_lock] and [/newsletter_lock] shortcodes or in place of the full content if they
                            are
                            in categories or have tags as specified above.<br>
                            You can use shortcodes like [newsletter_form] to display a subscription form or any other
                            Newsletter shortcode.
                            <strong>Remember to add the {unlock_url} on the welcome email so the user can unlock the
                                content.</strong>
                        </p>
                    </td>
                </tr>
