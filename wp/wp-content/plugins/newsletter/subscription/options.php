...
<div class="wrap" id="tnp-wrap">
    ...
    <div id="tnp-heading">
        ...
        <p>
            Page layout where messages are shown is managed by subscription/page.php file which contains instruction on
            how to
            ...
            <div id="tabs">
                    ...
                    <table class="form-table">
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    <strong>Double Opt In</strong> means subscribers need to confirm their email address
                                    by an activation link sent them on a activation email message.<br/>
                                    <strong>Single Opt In</strong> means subscribers do not need to confirm their email
                                    address.<br/>
                                </p>
                            </td>
                        </tr>
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <?php if (!empty($controls->data['url'])) { ?>
                                    <p class="description">
                                        <strong>
                                            You're currently using the URL
                                            <code><?php echo esc_html($controls->data['url']) ?></code>
                                            as dedicated page. Please select the corrisponding page above (new as
                                            version 4.6.5+).
                                        </strong>
                                    </p>
                                <?php } ?>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                to: <?php $controls->text_email('notify_email'); ?> (email address, leave empty for the
                                WordPress administration email <?php echo get_option('admin_email'); ?>)
                                <p class="description">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <?php if (apply_filters('newsletter_enqueue_style', true) === false) { ?>
                                    <p><strong>Warning: Newsletter styles and custom styles are disable by your theme or
                                            a plugin.</strong></p>
                                <?php } ?>
                    ...
                    <table class="form-table">
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    Use <strong>{subscription_form}</strong> to insert the subscription form where you
                                    prefer in the text or
                                    <strong>{subscription_form_N}</strong> (with N from 1 to 10) to insert one of the
                                    custom forms.
                                </p>
                            </td>
                        </tr>
                    ...
                    <table class="form-table">
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    This message is shown to just subscribed users which require to confirm the
                                    subscription
                                    following the instructions sent them with the following email. Invite them to check
                                    the mailbox and to
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    A full page address (http://yourblog.com/confirm) to be used instead of message
                                    above.
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    Message sent by email to new subscribers with instructions to confirm their
                                    subscription
                                    ...
                                    Sometime can be useful to add a <strong>{unsubscription_url}</strong> to let users
                                    to
                    ...
                    <table class="form-table">
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    ...
                                    settings or if signed up directly with no double opt-in process. You can use the
                                    <strong>{profile_form}</strong> tag to let the user to
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    A full page address (http://yourblog.com/welcome) to be used instead of message
                                    above. If empty the message is
                                    used.
                                </p>
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th>Conversion tracking code<br/>
                        ...
                        <tr valign="top">
                            <th>
                                Welcome email<br/>
                                <small>The right place where to put bonus content link</small>
                            </th>
                            <td>
                                ...
                                <p class="description">
                                    ...
                                    page, the welcome email. This is the right message where to put a <strong>{unlock_url}</strong>
                                    link to remember to the
                                    user where is the premium content (if any, main configuration panel).<br/>
                                    It's a good idea to add the <strong>{unsubscription_url}</strong> too and the
                    ...
                    <table class="form-table">
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    A full page address (e.g. http://yourblog.com/profile) to be used to show and edit
                                    the subscriber profile.
                                    Leave empty to use an auto generated page or the main Newsletter page with the
                                    message below.
                                    <br>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    This is the page where subscribers can edit their data and it must contain the
                                    {profile_form} tag. <a
                                            href="'https://www.thenewsletterplugin.com/plugins/newsletter/subscription-module#profile"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description">when a subscriber changes his email, he will be unconfirmed and a
                                    new confirmation email is sent</p>
                                <br><br>
                                generic error<br>
                                <?php $controls->text('profile_error', 80); ?>
                                <p class="description">when the email is not valid or already used by another
                                    subscriber</p>
                            </td>
                        </tr>
                    </table>
                ...
                <div id="tabs-7">
                    ...
                    <p>
                        ...
                        URL to build a link to confirmation of subscription when double opt-in is used. To be used on
                        confirmation email.<br/>
                        <strong>{unsubscription_url}</strong>
                        URL to build a link to start the cancellation process. To be used on every newsletter to let the
                        user to cancel.<br/>
                        <strong>{unsubscription_confirm_url}</strong>
                        URL to build a link to an immediate cancellation action. Can be used on newsletters if you want
                        an immediate cancellation or
                        on cancellation page (displayed on {unsubscription_url}) to ask a cancellation
                        confirmation.<br/>
                        <strong>{profile_url}</strong>
                        URL to build a link to user's profile page (see the User Profile panel)<br/>
                        <strong>{unlock_url}</strong>
                        Special URL to build a link that on click unlocks protected contents. See Main Configuration
                        panel.<br/>
