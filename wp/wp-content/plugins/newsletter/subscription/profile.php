...
<div class="wrap" id="tnp-wrap">
    ...
    <div id="tnp-heading">
        ...
        <p>
            This panel contains the configuration of the subscription and profile editing forms which collect the
            subscriber data you want to have.<br>
            And let you to <strong>translate</strong> every single button and label.<br>
            <strong>Preferences</strong> can be an important setting for your newsletter: <a
                    href="https://www.thenewsletterplugin.com/plugins/newsletter/newsletter-preferences"
                    target="_blank">here you can read more about them</a>.
        </p>
    ...
    <div id="tnp-body">
        ...
        <form action="" method="post">
            ...
            <div id="tabs">
                        ...
                        <tr>
                            ...
                            <td>
                                <table class="newsletter-option-grid">
                                    <tr>
                                        <th>Field label</th>
                                        <td><?php $controls->text('email', 50); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Error message</th>
                                        <td><?php $controls->text('email_error', 50); ?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <table class="newsletter-option-grid">
                                    <tr>
                                        <th>Field label</th>
                                        <td><?php $controls->text('name', 50); ?></td>
                                    </tr>
                                    <tr>
                                        <th>When to show</th>
                                    ...
                                    <tr>
                                        <th>Error message</th>
                                        <td><?php $controls->text('name_error', 50); ?></td>
                                    </tr>
                                </table>
                                <p class="description">
                        ...
                        <tr>
                            ...
                            <td>
                                <table class="newsletter-option-grid">
                                    <tr>
                                        <th>Field label</th>
                                        <td><?php $controls->text('surname', 50); ?></td>
                                    </tr>
                                    <tr>
                                        <th>When to show</th>
                                    ...
                                    <tr>
                                        <th>Error message</th>
                                        <td><?php $controls->text('surname_error', 50); ?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <table class="newsletter-option-grid">
                                    <tr>
                                        <th>Field label</th>
                                        <td><?php $controls->text('sex', 50); ?></td>
                                    </tr>
                                    <tr>
                                        <th>When to show</th>
                                    ...
                                    <tr>
                                        <th>Rules</th>
                                        <td><?php $controls->select('sex_rules', $rules); ?></td>
                                    </tr>
                                ...
                                <p class="description">
                                    Salutation titles are inserted in emails message when the tag {title} is used. For
                                    example
                            ...
                            <td>
                                <table class="newsletter-option-grid">
                                    <tr>
                                        ...
                                        <td><?php $controls->text('subscribe'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Save button</th>
                                        <td><?php $controls->text('save'); ?> (on profile page)</td>
                                    </tr>
                                </table>
                                <p class="description">
                                    For "subscribe" insert an URL to an image (http://...) to use it as a graphical
                                    button.
                                </p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <table class="newsletter-option-grid">
                                    <tr>
                                        <th>Enabled?</th>
                                        <td><?php $controls->yesno('privacy_status'); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Label</th>
                                        <td><?php $controls->text('privacy', 50); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Privacy URL</th>
                                        <td><?php $controls->text('privacy_url', 50); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Error message</th>
                                        <td><?php $controls->text('privacy_error', 50); ?></td>
                                    </tr>
                                </table>
                                <p class="description">
                                    The privacy acceptance checkbox (required in many Europen countries) force the
                                    subscriber to
                ...
                <div id="tabs-3">
                    <p>
                        Generic textual profile fields that can be collected during the subscription. Field formats can
                        be one line text
                        or selection list. Fields of type "list" must be configured with a set of options, comma
                        separated
                ...
                <div id="tabs-5">
                    ...
                    <p>This panel shows the form HTML code generated by Newsletter if you want to copy it as starting
                        point for a custom form.</p>

                    <h3>Standard form code</h3>
                    <textarea readonly
                              style="width: 100%; height: 500px; font-family: monospace"><?php echo esc_html(NewsletterSubscription::instance()->get_subscription_form_html5()); ?></textarea>

                    <h3>Widget form code</h3>
                    <textarea readonly
                              style="width: 100%; height: 500px; font-family: monospace"><?php echo htmlspecialchars(NewsletterSubscription::instance()->get_subscription_form()); ?></textarea>
