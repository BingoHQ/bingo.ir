...
class Newsletter extends NewsletterModule
{
    ...
    static $instance;
    var $time_start; // Per run, every 5 minutes
    var $time_limit;
    var $email_limit = 10;
    ...
    var $error;
    var $theme; // comma separated ids (eventually negative to exclude)
    var $theme_max_posts; // WP_Query object
    // Secret key to create a unique log file name (and may be other)
    var $theme_excluded_categories;
    var $theme_posts;
