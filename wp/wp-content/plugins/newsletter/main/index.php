                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                ...
                                                if (true || $email->status == 'sending') {
                                                    if ($email->send_on > time()) {
                                                        ...
                                                        ?>
                                                        <div id="canvas-nl-<?php echo $email->id ?>"
                                                             style="width:100px; height:5px; background-color: lightcoral;">
                                                            <div class="canvas-inner"
                                                                 style="background-color: green; width: <?php echo $email->total > 0 ? intval($email->sent / $email->total * 100) : 0 ?>%; height: 100%;">
                                                                &nbsp;
                                                            </div>
                                                        </div>
                                                        <?php
                                            ...
                                            <td style="white-space:nowrap">
                                                <a class="button-primary tnp-button-white"
                                                   ...
                                                   href="<?php echo $emails_module->get_admin_page_url(is_array($email_options) && array_key_exists('composer', $email_options) && $email_options['composer'] ? 'composer' : 'edit'); ?>&amp;id=<?php echo $email->id; ?>"><i
                                                            class="fa fa-pencil"></i></a>
                                                <a class="button-primary tnp-button-white"
                                                   title="<?php _e('Statistics', 'newsletter') ?>"
                                                   href="<?php echo NewsletterStatistics::instance()->get_statistics_url($email->id); ?>"><i
                                    ...
                                    <?php foreach ($subscribers as $s) { ?>
                                        <tr>
                                            ...
                                            <td><?php
                                                switch ($s->status) {
                                                    case 'S':
                                                        _e('NOT CONFIRMED', 'newsletter');
                                                        break;
                                                    case 'C':
                                                        _e('CONFIRMED', 'newsletter');
                                                        break;
                                                    case 'U':
                                                        _e('UNSUBSCRIBED', 'newsletter');
                                                        break;
                                                    case 'B':
                                                        _e('BOUNCED', 'newsletter');
                                                        break;
                                                }
                                                ?></td>
                                            <td style="white-space:nowrap">
