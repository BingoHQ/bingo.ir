...
<div class="wrap" id="tnp-wrap">
    ...
    <div id="tnp-heading">
        ...
        <p>
            <i class="fa fa-info-circle"></i> <a href="https://www.thenewsletterplugin.com/extensions" target="_blank">Discover
                how SMTP services can boost your newsletters!</a>
            <!--
        ...
        <p>
            ...
            <a href="https://www.thenewsletterplugin.com/plugins/newsletter/newsletter-configuration#smtp"
               target="_blank">here</a>.
            <br>
            On GoDaddy you should follow this <a
                    href="https://www.thenewsletterplugin.com/godaddy-using-smtp-external-server-shared-hosting"
                    target="_blank">special setup</a>.
        </p>
        <p>
            Consider <a href="https://www.thenewsletterplugin.com/affiliate/sendgrid" target="_blank">SendGrid</a> for a
            serious and reliable SMTP service.
        </p>
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">
                            Leave port empty for default value (25). To use Gmail try host "smtp.gmail.com" and port
                            "465" and SSL protocol (without quotes).
