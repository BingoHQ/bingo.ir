                ...
                <?php if ($e->type == "premium") { ?>
                    <div class="tnp-extension-premium-box <?php echo $e->slug ?>">
                        ...
                        <div class="tnp-extension-premium-action">
                            ...
                            <?php } else { ?>
                                <a href="https://www.thenewsletterplugin.com/premium?utm_source=plugin&utm_medium=link&utm_campaign=extpanel"
                                   class="tnp-extension-buy" target="_blank">
            ...
            <?php foreach ($extensions AS $e) { ?>
                ...
                <?php if ($e->type == "free") { ?>
                    <div class="tnp-extension-free-box <?php echo $e->slug ?>">
                        <img class="tnp-extensions-free-badge"
                             src="<?php echo plugins_url('newsletter') ?>/images/extension-free.png">
...
<div id="tnp-subscribe-overlay">
    <div id="tnp-subscribe-modal">
        ...
        <div id="tnp-subscribe-title">
            ...
            and be informed about updates and best practices.
        </div>
        <form method="post" action="?page=newsletter_main_extensions&noheader=true">
            ...
            <div id="tnp-subscribe-email-wrapper"><input type="email" id="tnp-subscribe-email" name="email"
                                                         value="<?php echo esc_attr(get_option('admin_email')) ?>">
            </div>
            <div id="tnp-subscribe-submit-wrapper"><input type="submit" id="tnp-subscribe-submit"
                                                          value="<?php esc_attr_e('Subscribe', 'newsletter') ?>"></div>
        </form>
        <div class="tnp-subscribe-no-thanks">
            <a href="javascript:void(jQuery('#tnp-subscribe-overlay').hide())">No thanks, I don't want to install the
                free extension</a>
        </div>
    </div>
</div>
