        ...
        <form method="post" action="">
            ...
            <table class="widefat" id="tnp-status-table">
                    ...
                    <td>
                        ...
                        <?php } else { ?>
                            ...
                            <ol>
                                ...
                                <li>If previous points do not apply to you, ask for support to your provider reporting
                                    the emails from your blog are not delivered
                                </li>
                            </ol>
                        <?php } ?>
                        <br>
                        <a href="https://www.thenewsletterplugin.com/documentation/email-sending-issues"
                           target="_blank">Read more to solve your issues, if any</a>.
                        <br>
                ...
                <tr>
                    ...
                    <td>
                        <?php if (!empty($return_path)) { ?>
                            Some providers require the return path domain
                            <code><?php echo esc_html($return_path_domain) ?></code> to be identical
                                                                                     to the sender domain
                            <code><?php echo esc_html($sender_domain) ?></code>. See the main settings.
                        <?php } else { ?>
                        <?php } ?>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php } else { ?>
                            ...
                            the <code>UTF-8</code> charset but the <a
                                    href="https://codex.wordpress.org/Converting_Database_Character_Sets"
                                    target="_blank">conversion</a>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php } else { ?>
                            Your PHP execution time limit is <?php echo $value ?> seconds and can be eventually changed by Newsletter
                            <br>
                        <?php } ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if (DB_CHARSET != 'utf8' && DB_CHARSET != 'utf8mb4') { ?>
                            ...
                            but the <a href="https://codex.wordpress.org/Converting_Database_Character_Sets"
                                       target="_blank">conversion</a>
                            could be tricky. If you're not experiencing problem, leave things as is.
                        <?php } else { ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php } else if ($delta <= -600) { ?>
                            The scheduler is very late: <?php echo $delta ?> seconds (<a
                                    href="https://www.thenewsletterplugin.com/plugins/newsletter/newsletter-delivery-engine"
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($res === false) { ?>
                            The Newsletter schedule is not present probably another plugin is interfering with the starndard WordPress schuling system.
                            <br>
                        <?php } else { ?>
                        <?php } ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php } ?>
                        <br>
                        Trigger interval: average <?php echo $wp_cron_calls_avg ?>&nbsp;s,
                        max <?php echo $wp_cron_calls_max ?>&nbsp;s, min <?php echo $wp_cron_calls_min ?>&nbsp;s
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <?php if (!$res) { ?>
                            The blog is not responding to Newsletter URLs: ask the provider or your IT consultant to check this problem. Report the URL and error blow
                            <br>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if ($memory < 64) { ?>
                            This value is too low you should increase it adding <code>define('WP_MEMORY_LIMIT',
                                '64M');</code> to your wp-config.php.
                        <?php } else if ($memory < 128) { ?>
                            The value should be fine, it depends on how many plugin you're running and how many resource are required by your theme.
                            Blank pages are usually syntoms of low memory. Eventually increase it adding <code>define('WP_MEMORY_LIMIT',
                                '128M');</code>
