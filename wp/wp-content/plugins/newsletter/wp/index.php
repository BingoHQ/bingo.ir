...
<div class="wrap" id="tnp-wrap">
    ...
    <div id="tnp-heading">
        ...
        <p>
            ...
            <a href="https://www.thenewsletterplugin.com/plugins/newsletter/subscription-module#registration"
               target="_blank">Read more on documentation page</a>.
        </p>
    ...
    <div id="tnp-body">
        ...
        <form method="post" action="">
            ...
            <p>
                Subscribers will be automatically confirmed on first log-in (because it demonstrates they received the
                WP email with
                their password. Hence no confirmation email is sent. Anyway you can change that behavior here and ask
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <p class="description">Delete the subscription connected to a WordPress user when that user is
                            deleted</p>
                    </td>
                </tr>
            </table>
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description">
                                <a href="https://www.thenewsletterplugin.com/plugins/newsletter/subscribers-module#import-wp-users"
                                   target="_blank">
