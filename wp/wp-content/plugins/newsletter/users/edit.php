            ...
            <div id="tabs">
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    If you collect only the name of the subscriber without distinction of first and last
                                    name this field is used.
                                </p>
                            </td>
                        </tr>
                        <tr valign="top">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    A test subscriber is a regular subscriber that is even used as recipint when sending
                                    test newsletter are sent
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    ...
                                    <a href="https://www.thenewsletterplugin.com/feed-by-mail-extension?utm_source=plugin&utm_medium=link&utm_campaign=newsletter-feed"
                                       target="_blank">feed by mail is an extension of this plugin</a>.
                                </p>
                            </td>
                        </tr>
                    </table>
                ...
                <div id="tabs-preferences">
                    <div class="tab-preamble">
                        <p>
                            The subscriber's preferences are a set of "on/off" fields that can be used while sending
                            newsletter to
                ...
                <div id="tabs-profile">
                    <div class="tab-preamble">
                        <p>
                            The user's profile is a set of optional and textual fields you can collect along with the
                            subscription process
                            or when the user's editing his profile. Those fields can be configured in the "Subscription
                            Form" panel.
                        </p>
                    </div>
                    <table class="widefat">
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    This secret token is used to access the profile page and edit profile data, to
                                    confirm and cancel the subscription.
                                </p>
                            </td>
                        </tr>
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    The URL which lands on the user profile editing page. It can be added on newsletters
                                    using the {profile_url} tag.
                                </p>
                            </td>
                        </tr>
                ...
                <div id="tabs-newsletters">
                    ...
                    <?php if (!has_action('newsletter_user_newsletters_tab') && !has_action('newsletter_users_edit_newsletters')) { ?>
                        <div class="tnp-tab-notice">
                            This panel requires the <a
                                    href="https://www.thenewsletterplugin.com/plugins/newsletter/reports-module"
                                    target="_blank">Reports Extension 4+</a>.
                        </div>
                        <?php
                    } else {
