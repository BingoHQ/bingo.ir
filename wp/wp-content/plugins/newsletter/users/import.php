...
<div class="wrap" id="tnp-wrap">
    ...
    <div id="tnp-heading">
        ...
        <p>
            The import and export functions <strong>ARE NOT for backup</strong>. If you want to backup you should
            consider to backup the
            wp_newsletter* tables. Please, read on bottom of this page the data format to use and other important notes.
        </p>
    ...
    <div id="tnp-body" class="tnp-users tnp-users-import">
        ...
        <?php if (!empty($results)) { ?>
            ...
            <textarea wrap="off"
                      style="width: 100%; height: 150px; font-size: 11px; font-family: monospace"><?php echo esc_html($results) ?></textarea>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <div class="hints">
                            <strong>Update</strong>: <?php _e('user data will be updated, existing preferences will be left untouched and new ones will be added.', 'newsletter') ?>
                            <br/>
                            <strong>Overwrite</strong>: <?php _e('user data will be overwritten with new informations (like name and preferences).', 'newsletter') ?>
                            <br/>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <textarea name="options[csv]" wrap="off"
                                  style="width: 100%; height: 200px; font-size: 11px; font-family: monospace"><?php echo $controls->data['csv']; ?></textarea>
                    </td>
                </tr>
                <tr>
                    <th>&nbsp;</th>
                    <td><?php $controls->button('import', 'Import'); ?></td>
                </tr>
                <tr>
                    <th>
            ...
            of your provider. It's safe to import the same list a second time, no duplications will occur.</span>
                    ...
                    <td>
                        ...
                        <p><strong>email</strong><i>[separator]</i><strong>first name</strong><i>[separator]</i><strong>last
                                name</strong><i>[separator]</i><strong>gender</strong><i>[new line]</i></p>
                        Example:
                        ...
                        <p>
                            where [separator] must be selected from the available ones. Empty lines and lines starting
                            with "#" will be skipped. There is
                            no separator escaping mechanism, so be sure that field values do not contain the selected
                            separator. The only required field is the email
