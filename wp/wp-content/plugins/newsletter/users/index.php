...
<div class="wrap" id="tnp-wrap">
    ...
    <div id="tnp-heading">
        ...
        <h2><?php _e('Search and Edit', 'newsletter') ?>
            <a class="tnp-btn-h1"
               href="?page=newsletter_users_new"><?php _e('Add a new subscriber', 'newsletter') ?></a>
        </h2>
    ...
    <div id="tnp-body" class="tnp-users tnp-users-index">
        ...
        <form id="channel" method="post" action="">
            ...
            <div class="tnp-paginator">
                ...
                <?php $controls->text('search_page', 3); ?>
                of <?php echo $last_page + 1 ?> <?php $controls->button('go', __('Go', 'newsletter')); ?>
                    ...
                    <tr class="<?php echo ($i++ % 2 == 0) ? 'alternate' : ''; ?>">
                        ...
                        <td>
                            <a class="button-secondary"
                               href="<?php echo $module->get_admin_page_url('edit'); ?>&amp;id=<?php echo $s->id; ?>"><?php _e('Edit', 'newsletter') ?></a>
                            ...
                            <a href="<?php echo home_url('/') ?>?na=p&nk=<?php echo $s->id . '-' . $s->token; ?>"
                               class="button-primary" target="_blank"><?php _e('Profile page', 'newsletter') ?></a>
                        </td>
