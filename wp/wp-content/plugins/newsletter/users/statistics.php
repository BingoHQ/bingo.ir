    ...
    <div id="tnp-body" class="tnp-users-statistics">
        ...
        <div id="tabs">
                ...
                <div class="tab-preamble">
                    <p>
                        ...
                        <a href="https://www.thenewsletterplugin.com/plugins/newsletter/newsletter-preferences"
                           target="_blank">Read more about lists</a> and/or
            ...
            <div id="tabs-referrers">
                <div class="tab-preamble">
                    <p>The referrer is a special (hidden) fields collected during the subscription. For example the
                        widget
            ...
            <div id="tabs-sources">
                ...
                <div class="tab-preamble">
                    <p>
                        URLs from which the subscription started. For example, if you use the widget on your blog
                        sidebar
                ...
                <script>
                    ...
                    jQuery(document).ready(function ($) {
                        ...
                        new Chart(gender_ctx, {
                            type: 'doughnut',
                            data: gender_data,
                            options: {responsive: false, legend: {labels: {boxWidth: 10}}}
                        });
                    });
                </script>
