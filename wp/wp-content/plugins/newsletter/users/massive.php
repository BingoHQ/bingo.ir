...
<div class="wrap" id="tnp-wrap">
    ...
    <div id="tnp-body" class="tnp-users tnp-users-massive">
        ...
        <?php if (!empty($results)) { ?>
            ...
            <textarea wrap="off"
                      style="width: 100%; height: 150px; font-size: 11px; font-family: monospace"><?php echo htmlspecialchars($results) ?></textarea>
        ...
        <form method="post" action="">
            ...
            <div id="tabs">
                    ...
                    <table class="widefat">
                        ...
                        <tr>
                            ...
                            <td nowrap>
                                ...
                                <p class="description">
                                    <a href="https://www.thenewsletterplugin.com/plugins/newsletter/subscribers-module#resend-confirm"
                                       target="_blank"><?php _e('We have some tips about global actions, read more.', 'newsletter') ?></a>
                                </p>
                            </td>
                        </tr>
                        <tr>
                ...
                <div id="tabs-4">
                    <p>
                        Import a set of bounced email addresses: they will be marked as "bounced" and no more contacted.
                        Sending
