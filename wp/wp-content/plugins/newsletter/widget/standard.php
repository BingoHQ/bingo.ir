        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('text'); ?>">
                ...
                <textarea class="widefat" rows="10" cols="20" id="<?php echo $this->get_field_id('text'); ?>"
                          name="<?php echo $this->get_field_name('text'); ?>"><?php echo esc_html($instance['text']); ?></textarea>
            </label>
            ...
            for ($i = 1; $i <= NEWSLETTER_LIST_MAX; $i++) {
                ...
                <label for="nl<?php echo $i ?>">
                    <input type="checkbox" value="<?php echo $i ?>"
                           name="<?php echo $this->get_field_name('nl[]') ?>" <?php echo array_search($i, $instance['nl']) !== false ? 'checked' : '' ?>> <?php echo esc_html($options_profile['list_' . $i]) ?>
                </label>
                <br>
            <?php } ?>
            ...
            <label for="<?php echo $this->get_field_id('old_form'); ?>">
                <input type="checkbox" id="<?php echo $this->get_field_id('old_form'); ?>"
                       name="<?php echo $this->get_field_name('old_form'); ?>" <?php echo isset($instance['old_form']) ? 'checked' : '' ?>>
