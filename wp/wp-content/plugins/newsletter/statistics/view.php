                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="tnp-widget">
                            ...
                            <h3>Subscribers Reached <a
                                        href="admin.php?page=newsletter_statistics_view_users&id=<?php echo $email->id ?>">Details</a>
                                <a href="admin.php?page=newsletter_statistics_view_retarget&id=<?php echo $email->id ?>">Retarget</a>
                            </h3>
                                ...
                                <div class="row tnp-row-values">
                                    <div class="col-md-6">
                                        <div class="tnp-data">
                                            <?php if ($email->status == 'sending' || $email->status == 'paused'): ?>
                                                ...
                                                <div class="tnp-data-value"><?php echo $email->sent; ?>
                                                    of <?php echo $email->total; ?></div>
                                            <?php else: ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="tnp-data">
                                            ...
                                            <div class="tnp-data-value"><?php echo $open_count; ?>
                                                (<?php echo $module->percent($open_count, $total_count); ?>)
                                            </div>
                                        </div>
                                        <div class="tnp-data">
                                            <div class="tnp-data-title">Clicked</div>
                                            <div class="tnp-data-value"><?php echo $click_count; ?>
                                                (<?php echo $module->percent($click_count, $total_count); ?>)
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tnp-widget">
                            ...
                            <div class="inside">
                                <a href="https://www.thenewsletterplugin.com/premium?utm_source=plugin&utm_medium=link&utm_content=worldmap&utm_campaign=newsletter-reports"
                                   target="_blank">
                                    <img style="width: 100%"
                                         src="<?php echo plugins_url('newsletter') ?>/statistics/images/map.gif">
                                </a>
                            </div>
                        </div>
                    </div>
