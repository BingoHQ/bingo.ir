        ...
        <form method="post" action="">
            ...
            <?php } else { ?>
                    ...
                    <div class="col-md-6">
                        <div class="tnp-widget">
                            ...
                            <div class="inside">
                                ...
                                <p class="tnp-events-legend">Subscribers interactions distribution over time,<br>starting
                                    from the sending day.</p>
                                                    ...
                                                    yAxes: [
                                                        {
                                                            ...
                                                            "id": "y-axis-1",
                                                            gridLines: {display: false},
                                                            ticks: {fontColor: "#27AE60", fontFamily: "Source Sans Pro"}
                                                        },
                                                        {
                                                            type: "linear",
                                                            "id": "y-axis-2",
                                                            position: "right",
                                                            gridLines: {display: false},
                                                            ticks: {fontColor: "#C0392B", fontFamily: "Source Sans Pro"}
                                                        }
                                                    ]
                                                },
                                                tooltips: {
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="tnp-data">
                                            ...
                                            <div class="tnp-data-value"><?php echo $open_count_total; ?>
                                                (<?php echo $module->percent($open_count_total, $total_sent); ?>)
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="tnp-data">
                                            ...
                                            <div class="tnp-data-value"><?php echo $click_count_total; ?>
                                                (<?php echo $module->percent($click_count_total, $total_sent); ?>)
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tnp-widget">
                            ...
                            <div class="inside">
                                ...
                                if (!has_action('newsletter_statistics_index_map')) {
                                    ?>
                                    <a href="https://www.thenewsletterplugin.com/premium?utm_source=plugin&utm_medium=link&utm_content=worldmap&utm_campaign=newsletter-reports"
                                       target="_blank">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="tnp-widget">
                            <h3><?php _e('Last newsletters', 'newsletter') ?> <a
                                        href="admin.php?page=newsletter_statistics_newsletters"><?php _e('Details', 'newsletter') ?></a>
                            </h3>
                            <div class="inside">
                                <?php
                                ...
                                <table class="widefat">
                                    ...
                                    <?php foreach ($emails as &$email) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo NewsletterStatistics::instance()->get_statistics_url($email->id); ?>"
                                                   class="button-primary">Statistics</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                    ...
                    <div class="col-md-6">
                        <div class="tnp-statistics-info-box">
                            ...
                            <a class="button-primary"
                               href="admin.php?page=newsletter_statistics_settings"><?php _e('Settings') ?></a>
                        </div>
                    </div>
                    <div class="col-md-6">
