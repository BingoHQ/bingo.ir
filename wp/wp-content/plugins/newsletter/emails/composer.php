...
if ($controls->is_action('preview')) {
    ...
    <div class="wrap">
        <p><a href="<?php echo $module->get_admin_page_url('cpreview'); ?>&id=<?php echo $email['id']; ?>">click here to
                proceed</a>.</p>
    </div>
    <?php
    return;
...
<div class="wrap" id="tnp-wrap">
    ...
    <div id="tnp-heading" class="tnp-composer-heading">
        ...
        <a href="https://www.thenewsletterplugin.com/plugins/newsletter/composer" target="_blank"><i
                    class="fa fa-life-ring"></i> <?php _e('Read the guide', 'newsletter') ?></a>
