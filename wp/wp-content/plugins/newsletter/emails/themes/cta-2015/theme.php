...
<table width="500" cellpadding="0" cellspacing="0" align="center" bgcolor="#ffffff" border="0">
    ...
    <tr>
        <td style="font-family: Verdana">
            ...
            <!-- cta -->
            <table cellpadding="15" cellspacing="0" align="center" bgcolor="<?php echo $color ?>" border="0"
                   style="border-radius: 5px">
                <tr>
                    <td><a href="#" style="font-size: 15px; color: #ffffff; text-decoration: none">Call to action</a>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <?php if (!empty($theme_options['main_facebook_url'])) { ?>
                        <td align="center" valign="top">
                            <a href="<?php echo $theme_options['main_facebook_url'] ?>"><img
                                        src="<?php echo $social_icon_url ?>/facebook.png" alt="Facebook"></a>
                        </td>
                    <?php } ?>

                    <?php if (!empty($theme_options['main_googleplus_url'])) { ?>
                        <td align="center" valign="top">
                            <a href="<?php echo $theme_options['main_googleplus_url'] ?>"><img
                                        src="<?php echo $social_icon_url ?>/googleplus.png"></a>
                        </td>
                    <?php } ?>

                    <?php if (!empty($theme_options['main_twitter_url'])) { ?>
                        <td align="center" valign="top">
                            <a href="<?php echo $theme_options['main_twitter_url'] ?>"><img
                                        src="<?php echo $social_icon_url ?>/twitter.png"></a>
                        </td>
                    <?php } ?>

                    <?php if (!empty($theme_options['main_linkedin_url'])) { ?>
                        <td align="center" valign="top">
                            <a href="<?php echo $theme_options['main_linkedin_url'] ?>"><img
                                        src="<?php echo $social_icon_url ?>/linkedin.png"></a>
                        </td>
                    <?php } ?>

                    <?php if (!empty($theme_options['main_youtube_url'])) { ?>
                        <td align="center" valign="top">
                            <a href="<?php echo $theme_options['main_youtube_url'] ?>"><img
                                        src="<?php echo $social_icon_url ?>/youtube.png"></a>
                        </td>
                    <?php } ?>

                    <?php if (!empty($theme_options['main_vimeo_url'])) { ?>
                        <td align="center" valign="top">
                            <a href="<?php echo $theme_options['main_vimeo_url'] ?>"><img
                                        src="<?php echo $social_icon_url ?>/vimeo.png"></a>
                        </td>
                    <?php } ?>
                    <?php if (!empty($theme_options['main_instagram_url'])) { ?>
                        <td align="center" valign="top">
                            <a href="<?php echo $theme_options['main_instagram_url'] ?>"><img
                                        src="<?php echo $social_icon_url ?>/instagram.png"></a>
                        </td>
                    <?php } ?>
                </tr>
            </table>
