                        ...
                        <table border="0" cellpadding="10" cellspacing="0" width="100%">
                            <tr>
                                <td valign="top" align="left"
                                    style="color: #505050;font-family: Arial;font-size: 10px;">
                                    You are receiving this email because you subscribed
                                    to <?php echo get_option('blogname'); ?>. <a href="{profile_url}">Click here to
                                        change your subscription</a>.
                                </td>
                                <td valign="top" width="190" align="left"
                                    style="color: #505050;font-family: Arial;font-size: 10px;">
                                    Is this email not displaying correctly?<br><a href="{email_url}"
                                                                                  style="color: #336699;font-weight: normal;text-decoration: underline;">View
                                        it online</a>.
                                </td>
                            </tr>
                        </table>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" bgcolor="#FFFFFF">
                <tr>
                    <td align="center" valign="middle" height="150"
                        style="color: #202020;font-family: Arial;font-size: 34px;font-weight: bold;line-height: 100%;padding: 5px 0 -2px 0;border-width: 1px 0px;border-style: solid;border-color: #dddddd;">
                ...
                <tr>
                    ...
                    <td valign="top">
                        <table border="0" cellpadding="20" cellspacing="0" width="200">
                            <tr>
                                <td valign="top" align="left"
                                    style="color: #505050;font-family: Arial;font-size: 12px;line-height: 150%;">
                                    Sidebar text
                                </td>
                            </tr>
                            <?php
                                    ...
                                    <td valign="top" align="left">
                                        ...
                                        foreach (array('facebook', 'twitter', 'youtube', 'linkedin', 'googleplus', 'pinterest', 'tumblr', 'instagram') as $social) {
                                            if (empty($theme_options["theme_$social"]))
                                                continue;
                                            ?>
                                            <a href="<?php echo $theme_options["theme_$social"]; ?>"><img
                                                        src="<?php echo $social_icon_url; ?>/<?php echo $social; ?>.png"
                                                        alt="<?php echo $social; ?>"></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php } ?>
                            ...
                            <tr>
                                <td valign="top">
                                    ...
                                    <?php foreach ($posts as $post) {
                                        ...
                                        <center><img
                                                    src="<?php echo newsletter_get_post_image($post->ID, 'medium'); ?>">
                                        </center>
