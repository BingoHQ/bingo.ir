...
<head>
    ...
    <?php echo $theme_url; ?>
    /images/bg.jpg'); font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 14px; color: #666; margin: 0 auto; padding: 0;"
    >
    < br >
    < table align
    ...
    =
    "color: #b00; font-size: 50px; font-family: serif; font-style: italic;"
    ...
    =
    "5"
    > < tr ><?php for ($i=0; $i<3; $i++) { $post = $posts[$i]; setup_postdata($post); ?> < td align
    ...
    =
    "font-size: 14px; line-height: 26px; font-weight: bold; color: #000; text-decoration: none"
    ...
    =
    "display: block; width: 200px; height: 170px; overflow: hidden"
    > < img width
    ...
    /
    tr > < tr ><?php for ($i=3; $i<6; $i++) { $post = $posts[$i]; setup_postdata($post); ?> < td align
    ...
    /
    tr > < tr ><?php for ($i=6; $i<9; $i++) { $post = $posts[$i]; setup_postdata($post); ?> < td align
    ...
    table > < br > < br ><?php
                            ...
                            ?> < small > To change your subscription,
