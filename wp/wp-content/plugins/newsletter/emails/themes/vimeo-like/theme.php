...
<table style="background:#ffffff; max-width: 100%" width="600" align="center" border="0" cellpadding="0"
       cellspacing="0">
            ...
            <table width="100%" align="center" border="0" cellpadding="20" cellspacing="0">
                ...
                <tr>
                    <td style="background:#ffffff">
                        ...
                        <p style="color:#456;font-family:arial,sans-serif;font-size:24px;line-height:1.2;margin:15px 0;padding:0">
                            <a target="_tab" href="<?php echo get_option('home'); ?>"
                               style="color:#28c;text-decoration:none"
                               target="_blank"><?php echo get_option('blogname'); ?></a></p>
                                ...
                                <tr>
                                    ...
                                    <td style="width:100%;padding:0 10px 0 0;vertical-align:top">
                                        ...
                                        <p style="font-family:arial,sans-serif;color:#456;font-size:20px;line-height:22px;margin:0;padding:0">
                                            <strong><a target="_tab" href="<?php echo get_permalink(); ?>"
                                                       style="color:#456;text-decoration:none"
                                                       target="_blank"><?php the_title(); ?></a></strong></p>

                                        <p style="font-family:arial,sans-serif;line-height:1.5em;margin:15px 0;padding:0"><?php the_excerpt(); ?>
                                            . </p>
                                    ...
                                    <td style="vertical-align:middle; width: 100px">
                                        ...
                                        <a target="_tab" href="<?php echo get_permalink(); ?>" target="_blank"><img
                                                    src="<?php echo $image; ?>" alt="" width="100" border="0"
                                                    height="100"></a>

                                        <p style="background:#2786c2;text-align:center;margin:10px 0 0 0;font-size:11px;line-height:14px;font-family:arial,sans-serif;padding:4px 2px;border-radius:4px">
                                            <a target="_tab" href="<?php echo get_permalink(); ?>"
                                               style="color:#fff;text-decoration:none"
                                               target="_blank"><strong><?php echo $theme_options['theme_read_more']; ?></strong></a>
                                        </p>
