    ...
    <table cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" width="600" align="center">
        ...
        <tr>
            ...
            <td width="560">
                ...
                <p>The Newsletter Team wishes you merry Christmas and happy New Year. This time of year is special for
                    us and we would like
                    to share this time with you, also.</p>

                <p>We'll take a rest for few days with our families but we have a <strong>big surprise</strong> for YOU
                    that will
                    be unvealed the first days of the New Year.</p>

                <p>Curious? You can <a href="<?php echo get_option('blogname'); ?>">discover a little more right now</a>.
                </p>
