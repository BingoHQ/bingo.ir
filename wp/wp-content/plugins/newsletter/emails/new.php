...
if ($controls->is_action('theme')) {
    ...
    if ($controls->data['theme'] == 'rawhtml' || !file_exists($module->get_current_theme_file_path('theme-options.php'))) {
        ...
        <div class="wrap">
            <p>If you are not automatically redirected to the composer, <a
                        href="<?php echo $module->get_admin_page_url('edit'); ?>&id=<?php echo $email->id; ?>">click
                    here</a>.</p>
        </div>
        <?php
        return;
...
if ($controls->is_action('create')) {
    ...
    <div class="wrap">
        <p><a href="<?php echo $module->get_admin_page_url('edit'); ?>&id=<?php echo $email->id; ?>">click here to
                proceed</a>.</p>
    </div>
    <?php
    return;
...
<div class="wrap" id="tnp-wrap">
    ...
    <div id="tnp-heading">
        ...
        <h2><?php _e('Create a newsletter', 'newsletter') ?>
            <a class="tnp-btn-h1"
               href="<?php echo NewsletterEmails::instance()->get_admin_page_url('theme'); ?>"><?php _e('Back to newsletter themes', 'newsletter') ?></a>
        </h2>
        <br>
            ...
            <table style="width: 100%; border-collapse: collapse">
                <tr>
                    ...
                    <td style="text-align: left; vertical-align: top; border-bottom: 1px solid #ddd; padding-bottom: 10px">
                        ...
                        <img style="position: relative; left: 5px; top: 10px;"
                             src="<?php echo plugins_url('newsletter') ?>/images/arrow.png" height="35">
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="vertical-align: top; padding-top: 15px; padding-left: 15px">
                        <iframe src="<?php echo wp_nonce_url(home_url('/', is_ssl() ? 'https' : 'http') . '?na=emails-preview&ts=' . time(), 'view'); ?>"
                                height="700" style="width: 100%; border: 1px solid #ccc"></iframe>
                    </td>
                </tr>
            </table>
