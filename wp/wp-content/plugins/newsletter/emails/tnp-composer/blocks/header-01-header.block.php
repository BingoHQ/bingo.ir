                                    ...
                                    <td width="100" align="left" class="tnpc-row-edit" data-type="image">
                                        <a href="#" target="_blank">
                                            <?php if (!empty($block_options['header_logo']['url'])) { ?>
                                                <img alt="<?php echo esc_attr($block_options['header_title']) ?>"
                                                     src="<?php echo $block_options['header_logo']['url'] ?>"
                                                     style="display: block; width: 180px;" border="0">
                                            <?php } else { ?>
                                                <img alt="<?php echo esc_attr($block_options['header_title']) ?>"
                                                     src="http://placehold.it/180x100&text=<?php echo esc_attr($block_options['header_title']) ?>"
                                                     style="display: block; width: 180px;" border="0">
                                            <?php } ?>
                                        </a>
                                    </td>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="right"
                                                    ...
                                                    class="tnpc-row-edit" data-type="text">
