...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tnpc-row tnpc-row-posts" data-id="content-06"
       data-block="content-06-posts">
    <tr>
        <td bgcolor="<?php echo $bgcolor ?>" align="center" style="padding: 70px 15px 70px 15px;"
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="500" style="padding:0 0 20px 0;"
                ...
                <tr>
                    <td align="center"
                        style="padding: 0 0 10px 0; font-size: 25px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #333333;"
                        class="padding-copy tnpc-row-edit" data-type="title" colspan="2">From Our Blog
                    </td>
                </tr>
                ...
                <?php foreach ($posts AS $post) { ?>
                    ...
                    <tr>
                        <td valign="top" style="padding: 40px 0 0 0;" class="mobile-hide tnpc-row-edit"
                            data-type="image">
                            <a href="<?php echo tnp_post_permalink($post) ?>" target="_blank">
                                <img src="<?php echo tnp_post_thumbnail_src($post) ?>" width="105" height="105"
                                     border="0"
                                     style="display: block; font-family: Arial; color: #666666; font-size: 14px; width: 105px!important; height: 105px!important;">
                            </a>
                        </td>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        class="padding-copy tnpc-row-edit" data-type="title">
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        class="padding-copy tnpc-row-edit" data-type="text">
