            ...
            <table width="500" border="0" cellspacing="0" cellpadding="0" align="center" class="responsive-table">
                <tr>
                    <td align="center"
                        ...
                        <a class="original-only tnpc-row-edit" data-type="link"
                           style="color: #666666; text-decoration: none;"
                           href="{profile_url}"><?php _e('Change your subscription', 'newsletter') ?></a>

                        <span class="original-only"
                              style="font-family: Arial, sans-serif; font-size: 12px; color: #444444;">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>

                        <a style="color: #666666; text-decoration: none;" href="{email_url}" class="tnpc-row-edit"
                           data-type="link"><?php _e('View online', 'newsletter') ?></a>
