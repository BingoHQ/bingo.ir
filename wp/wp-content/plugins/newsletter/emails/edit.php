            ...
            <div id="tabs">
                ...
                <div id="tabs-a">
                    ...
                    <?php if ($email['editor'] == 0) { ?>
                        ...
                        <a href="https://www.thenewsletterplugin.com/plugins/newsletter/newsletter-tags"
                           target="_blank"><?php _e('Available tags', 'newsletter') ?></a>
                        <br><br>
                ...
                <div id="tabs-b">
                    <?php if (Newsletter::instance()->options['phpmailer'] == 0) { ?>
                        <p class="tnp-tab-warning">The text part is sent only when Newsletter manages directly the
                            sending process. <a href="admin.php?page=newsletter_main_main" target="_blank">See the main
                                settings</a>.</p>
                    <?php } ?>
                    <p>
                        This is the textual version of your newsletter. If you empty it, only an HTML version will be
                        sent but
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    You can address the newsletter to subscribers who selected at least one of the
                                    options or to who
                                    has not selected at least one of the options.
                                    <a href="https://www.thenewsletterplugin.com/plugins/newsletter/newsletter-preferences"
                                       target="_blank">Read more about the "NOT ACTIVE" usage</a>.
                                </p>
                            </td>
                        </tr>
                    ...
                    <table class="form-table">
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    ...
                                    <?php _e('Required', 'newsletter') ?>: <a href="" target="_blank">Newsletter Archive
                                        Extension</a>
                                </p>
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                (now: <?php echo date_i18n(get_option('date_format') . ' ' . get_option('time_format')); ?>
                                )
                                <p class="description">
                                    If the current date and time are wrong, check your timezone on the General WordPress
                                    settings.
                                </p>
                            </td>
                        </tr>
