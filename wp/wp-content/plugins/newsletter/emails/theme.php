...
<div class="wrap" id="tnp-wrap">
    ...
    <div id="tnp-heading">
        ...
        <h2><?php _e('Select a theme', 'newsletter') ?>
            <a class="tnp-btn-h1" href="https://www.thenewsletterplugin.com/plugins/newsletter/newsletter-themes"
               target="_blank">Custom themes</a>
        </h2>
    ...
    <div id="tnp-body" class="tnp-darkbg">
        ...
        <form method="post" id="newsletter-form" action="<?php echo $module->get_admin_page_url('new'); ?>">
            ...
            <div class="tnp-theme-preview">
                ...
                <a href="<?php echo $module->get_admin_page_url('composer'); ?>"
                   style="margin-right: 20px; margin-bottom: 20px">
                    <img src="<?php echo plugins_url('newsletter') . '/emails/themes/composer.gif' ?>" width="420"
                         height="200">
                </a>
            </div>
            ...
            <div class="tnp-theme-preview">
                ...
                <a href="#" onclick="var f = document.getElementById('newsletter-form');
                    ...
                    <img src="<?php echo plugins_url('newsletter') . '/emails/images/html.png' ?>" width="200"
                         height="200">
                </a>
            </div>
